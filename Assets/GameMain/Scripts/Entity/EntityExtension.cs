...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        {
            entityComponent.ShowEntity(typeof(PlayerTom), "PlayerTom", Constant.AssetPriority.PlayerAsset,data);
        }

        public static void ShowMonster(this EntityComponent entityComponent, MonsterData data)
        {
            entityComponent.ShowEntity(typeof(SoulMonster), "SoulMonster", Constant.AssetPriority.MonsterAsset, data);
        }
